...
git clone https://github.com/AbuRider/android_device_xiaomi_earth.git -b lineage-22.1 device/xiaomi/earth || { echo "Failed to clone device tree"; }

git clone https://github.com/mt6768-dev/proprietary_vendor_xiaomi_earth.git -b lineage-22.1 vendor/xiaomi/earth || { echo "Failed to clone vendor tree"; }
...
git clone https://github.com/LineageOS/android_device_mediatek_sepolicy_vndr.git -b lineage-22.1 device/mediatek/sepolicy_vndr || { echo "Failed to sepolicy_vndr"; }
