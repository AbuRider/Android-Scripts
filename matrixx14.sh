...
git clone https://github.com/AbuRider/android_device_xiaomi_earth.git -b lineage-21 device/xiaomi/earth || { echo "Failed to clone device tree"; }
...
git clone https://github.com/AbuRider/android_kernel_xiaomi_earth.git -b lineage-21 kernel/xiaomi/earth || { echo "Failed to clone kernel tree"; }
